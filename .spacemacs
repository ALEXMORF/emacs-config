...
you should place your code here."
  ...
  (interactive)
  (compile "build.bat"))
  (define-key evil-insert-state-map (kbd "M-m") 'make-without-asking)
  (define-key evil-normal-state-map (kbd "M-m") 'make-without-asking)
  (define-key evil-visual-state-map (kbd "M-m") 'make-without-asking)
